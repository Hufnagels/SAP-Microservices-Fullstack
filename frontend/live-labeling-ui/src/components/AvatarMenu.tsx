...
export function AvatarMenu() {
  ...
  const hasAvatar = user?.avatar_mode === 'image' && !!user?.avatar_base64
    ...
    <>
      ...
      <button
        ...
        style={{
          width: 30, height: 30,
          borderRadius: '50%',
          background: hasAvatar ? 'transparent' : open ? 'var(--accent, #3b82f6)' : 'var(--bg-input)',
      ...
      >
        {hasAvatar
          ? <img src={user!.avatar_base64!} alt={initials(user)} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} />
          : initials(user)
        }
      </button>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: hasAvatar ? 'transparent' : 'var(--accent, #3b82f6)',
              border: '1px solid var(--border)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              {hasAvatar
                ? <img src={user!.avatar_base64!} alt={initials(user)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                : initials(user)
              }
            </div>
            <div>
