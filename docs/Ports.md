...
|---|---|---|
| `SAP_B1_SERVICE_LAYER_URL` | `https://172.22.248.4:50000/b1s` | SAP Business One Service Layer base URL |
| `SAP_B1_COMPANY_DB` | `BRD_PS_20250407` | SAP company database name |
| `SAP_B1_USERNAME` | `termelesig` | SAP login user |
